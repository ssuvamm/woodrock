        ...
        <div className="mx-auto max-w-2xl md:max-w-4xl lg:max-w-6xl">
          ...
          <div className="grid grid-cols-1 gap-8 md:flex md:justify-center md:gap-12">
            <div>
              <div className="flex  justify-center rounded-[10px]">
                <img
                  ...
                  alt="Navneet Agarwal"
                  className="h-32 w-32 overflow-hidden rounded-[10px]"
                />
              </div>
              <h3 className="mb-2 text-xl font-bold ">Navneet Agarwal</h3>
              <p className="">COO of Woodrock Group</p>
            ...
            <div>
              <div className="flex  justify-center rounded-[10px]">
                <img
                  src="/leaders/yogesh.webp"
                  alt="Yogesh Mishra"
                  className="h-32 w-32 overflow-hidden rounded-[10px]"
                />
              </div>
              <h3 className="mb-2 text-xl font-bold ">Yogesh Mishra</h3>
              <p className="">CTO of Woodrock Group</p>
            ...
            <div>
              ...
              <p className=" ">CMO of Woodrock Group</p>
